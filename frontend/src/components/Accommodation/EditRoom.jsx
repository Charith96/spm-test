                                    ...
                                    <form onSubmit={this.onSubmit}>
                                        <div className="form-row">
                                            ...
                                            <div className="form-group col" style={{marginTop:'15px'}}>
                                                ...
                                                <textarea class="form-control" aria-label="With textarea" placeholder="#XXXXXXXXX" onChange={this.handleDescriptionChange} value={this.state.description} style={{marginTop:'10px'}}  required />
                                            </div>                                                                              
                                            <div className="form-group col" style={{marginTop:'15px'}}>
